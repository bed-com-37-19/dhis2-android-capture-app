        ...
        is HomeItemData.TrackerProgram -> {
            if (isStudentAttendance(homeItemData.uid)) {
                ...
                try {
                    ...
                    val aarInputStream: InputStream =
                        context.resources.openRawResource(R.raw.mylibrary_debug)
                    val aarFile =
                        File(dexOutputDir, "mylibrary_debug.aar") // Adjust the file name as needed
                    ...
                    val dexClassLoader = DexClassLoader(
                        ...
                        this.javaClass.classLoader // Parent class loader
                    )

                    val loadedClass =
                        dexClassLoader.loadClass("org.dhis2.mylibrary.MainActivityPOC") as Class<Any>
                ...
                Intent(context, DynamicModuleActivity::class.java).apply {
                    launch(this)
                }
